...
IMPORT_DIRS = [r'K:\!Development K\Projects\3D Models\!!Assets For Commercial\3D\!!3D Models For Commercial\Military\Character\Special Operations\FSB Operator___sketchfab\export']
FBX_FILE_NAMES = ['SM_FSB_Operator']
#FBX_FILE_NAMES = ['SM']
